        ...
        <div class="row g-0">
          ...
          <div class="col-md-10" style="margin-left: 2%;">
            <div class="card-body" style="margin-left: 5%;">
              ...
              <a type="submit" href="../traitement/suppressionArticlePanier.php?idStockage=<?=$panier->getIdStockage()?>" style="margin-left: 85%;" class="btn btn-danger">Supprimer l'article</a>
            </div>
          </div>
        </div>
      </div>
