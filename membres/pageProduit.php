...
?>
<main style="min-height:69.2vh">

    <div class="container  d-flex justify-content-center my-2">
        <div class="card mb-3 descriptionProduit">
            <div class="row g-0">
                <div class="col-md-5 produitImage">
                    <img alt="Couverture du Produit" style="max-width: 300px;" src="<?= $Livre->getPhoto() ?>">
                </div>
                <div class="col-md-7">
                    <div class="card-body">
    ...
    <div class="container BackGround roundBorder py-1 mb-2">
        <form method="post" action='../traitement/ajoutCommentaire.php?idLivre=<?= $idLivre ?>'>
            ...
            <div class="form-group my-1">
                ...
                <input type="text" class="form-control" name="Entete" id="Entete" placeholder="Saisisser votre titre ici !" />
            </div>
            <div class="form-group">
